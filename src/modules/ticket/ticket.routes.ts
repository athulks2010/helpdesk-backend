...
ticketWithMiddleware.put('/update', async (req) =>
  ticketController.update(req.body, (req as any).tokenHolder)
)
ticketWithMiddleware.get('/activities', async (req) => ticketController.getActivities(req.query))
